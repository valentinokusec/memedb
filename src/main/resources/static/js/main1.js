...
;(function(window) {
	...
	$("#build_id").append($("#build_text").text());
	$("#summoners_id").append($("#summoners_text").text());
	$("#masteries_id").append($("#masteries_text").text());
	$("#runes_id").append($("#runes_text").text());
	$("#content_id").append($("#content_text").text());
